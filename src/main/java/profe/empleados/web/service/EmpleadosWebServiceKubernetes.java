...
public class EmpleadosWebServiceKubernetes implements EmpleadosWebService {
	...
	protected String empleadosServiceAlias;

	protected Logger logger = Logger.getLogger(EmpleadosWebServiceKubernetes.class
			.getName());
